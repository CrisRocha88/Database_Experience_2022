...
INSERT INTO idClient (Fname, Minit, Lname, CPF, Address)
		VALUES('Cristina', 'F', 'Rocha', 1234567878, 'rua Sueli, Uglione - Cidade Santa Maria'),
			  ('Marcelo', 'F', 'Jesus', 45678913, 'avenida Presidente  1009, Centro - Cidade das Margaridas'),
			  ('Marta', 'S', 'Teixeira', 98745631, 'rua Ana Nery, Centro - Cidade Dos formigueiros'),
              ('João', 'G', 'Marcelo', 789123456, 'André , Centro - Cidade de Uglione');
